...
ActiveRecord::Schema[7.2].define(version: 2025_07_10_191900) do
  ...
  create_table "vulnerabilities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
